...
4. Founding cohort: 45 personal invitations between September 21 and 25 (five on the 21st as a smoke) to net about 30 started trials, founding price 79.99 a year plus tax, founding membership capped at 100 overall. Recommendation: yes. Default: yes.
...
- Revenue path: referral (give a month, get a month) moved into Phase 2 engineering; founding cohort capped at 100 with a close date.
